...
#calc_field_BA(raw_data = summit.lk.dat, live = TRUE) # You need to run lines 34-37 prior to this line (read in Summit Lake field data)
...
#calc_field_BA(raw_data = summit.lk.dat, live = FALSE) # You need to run lines 34-37 prior to this line (read in Summit Lake field data)
...
ggplot(NULL, aes(x = timestep,  y = C_unit, fill = treatment, group = treatment)) + 
  geom_Dine(data = out_0506_D_C_T, aes(col = treatment), size = 1.2) + 
