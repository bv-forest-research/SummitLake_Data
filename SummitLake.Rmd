...
#SL_calc_field_C(raw_data = summit.lk.dat, live = TRUE) # You need to run lines 34-37 prior to this line (read in Summit Lake field data)
...
#raw_data_C_Sx < SL_calc_field_C(raw_data = summit.lk.dat, live = TRUE, spp = "Sx")
raw_data_C_Sx <- read.csv("./Outputs/csv/SummitLake_C_field_L_Sx.csv")

# Subset for final year
final_field_C_L_Sx <- subset(raw_data_C_Sx, timestep == 27)
...
#raw_data_C_Bl < SL_calc_field_C(raw_data = summit.lk.dat, live = TRUE, spp = "Bl")
raw_data_C_Bl <- read.csv("./Outputs/csv/SummitLake_C_field_L_Bl.csv")

# Subset for final year
final_field_C_L_Bl <- subset(raw_data_C_Bl, timestep == 27)
